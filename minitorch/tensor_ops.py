    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _zip(
        ...
        for i in range(len(out)):
            ...
            out_postiion = index_to_position(out_index, out_strides)

            a_poistion = index_to_position(a_index, a_strides)

            b_position = index_to_position(b_index, b_strides)

            out[out_postiion] = fn(a_storage[a_poistion], b_storage[b_position])
    ...
    def _reduce(
        ...
        for i in range(len(out)):
            ...
            for a_dim in range(a_shape[reduce_dim]):
                ...
                out[i] = fn(out[out_position], a_storage[a_position])
