...
class FastTrain:
    ...
    def train(self, data, learning_rate, max_epochs=500, log_fn=default_log_fn):
        ...
        print("Total time: ", total_epoch_time)
        print("Average time: ", total_epoch_time / max_epochs)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--EPOCHS", default=500, help="dataset")
    ...
    ).train(data, RATE, max_epochs=EPOCHS)
